...
public class PersonSelectorTest extends ElementTest {
  ...
  public void sendValidPersonSelectorOnPresentationML() throws Exception {
    context.parseMessageML("<messageML><form id=\"" + formId + "\"><div class=\"person-selector\" data-name=\"one-name\" data-placeholder=\"some-placeholder\" data-required=\"true\"/></form></messageML>", null, MessageML.MESSAGEML_VERSION);
  ...
  public void sendInvalidAttrPersonSelectorOnPresentationML() throws Exception {
    ...
    context.parseMessageML("<messageML><form id=\"" + formId + "\"><div id=\"idOne\" class=\"person-selector\" data-name=\"any-name\"/></form></messageML>", null, MessageML.MESSAGEML_VERSION);
  }
  ...
  public void sendInvalidContentPersonSelectorOnPresentationML() throws Exception {
    ...
    context.parseMessageML("<messageML><form id=\"" + formId + "\"><div class=\"person-selector\" data-name=\"any-name\"><div>hey</div></div></form></messageML>", null, MessageML.MESSAGEML_VERSION);
  }

  @Test
  public void sendValidPersonSelector() throws Exception {
    String name = "some-name";
    context.parseMessageML("<messageML><form id=\"" + formId + "\"><person-selector name=\"" + name + "\" placeholder=\"Add some user here...\" required=\"false\"/></form></messageML>", null, MessageML.MESSAGEML_VERSION);
  ...
  public void sendValidPersonSelectorWithClosingTag() throws Exception {
    ...
    context.parseMessageML("<messageML><form id=\"" + formId + "\"><person-selector name=\"" + name +"\" placeholder=\"Add some user here...\"></person-selector></form></messageML>", null, MessageML.MESSAGEML_VERSION);
  ...
  public void sendPersonSelectorWithChildElement() throws Exception {
    expectedException.expect(InvalidInputException.class);
    expectedException.expectMessage("Element \"person-selector\" may not have child elements or text content");
    context.parseMessageML("<messageML><form id=\"" + formId + "\"><person-selector name=\"name\">a</person-selector></form></messageML>", null, MessageML.MESSAGEML_VERSION);
  }
  ...
  public void sendPersonSelectorWithInvalidRequiredAttribute() throws Exception {
    ...
    context.parseMessageML("<messageML><form id=\"" + formId + "\"><person-selector name=\"some-name\" placeholder=\"Person placeholder\" required=\"invalid\"/></form></messageML>", null, MessageML.MESSAGEML_VERSION);
  }
  ...
  public void sendPersonSelectorWithInvalidAttribute() throws Exception {
    ...
    context.parseMessageML("<messageML><form id=\"" + formId + "\"><person-selector class=\"some-class\"/></form></messageML>", null, MessageML.MESSAGEML_VERSION);
  }

  @Test
  public void sendPersonSelectorOutsideForm() throws Exception {
    context.parseMessageML("<messageML><form id=\"" + formId + "\"><div><person-selector name=\"some-name\"/></div></form></messageML>", null, MessageML.MESSAGEML_VERSION);
