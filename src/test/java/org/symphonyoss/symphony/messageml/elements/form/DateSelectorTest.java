...
public class DateSelectorTest extends ElementTest {
  ...
  public void beforeEach() {
    this.formId = randomizeId("id");
  }
  
  @Test
  public void sendValidDateSelectorOnPresentationML() throws Exception {
    context.parseMessageML("<messageML><form id=\"" + formId + "\"><div class=\"date-selector\" data-name=\"some-name\" data-placeholder=\"some-placeholder\" data-required=\"true\"/></form></messageML>", null, MessageML.MESSAGEML_VERSION);
  ...
  public void sendInvalidAttrDateSelectorOnPresentationML() throws Exception {
    ...
    context.parseMessageML("<messageML><form id=\"" + formId + "\"><div id=\"idOne\" class=\"date-selector\" data-name=\"some-name\"/></form></messageML>", null, MessageML.MESSAGEML_VERSION);
  }
  ...
  public void sendInvalidContentDateSelectorOnPresentationML() throws Exception {
    ...
    context.parseMessageML("<messageML><form id=\"" + formId + "\"><div class=\"date-selector\" data-name=\"some-name\"><div>hey</div></div></form></messageML>", null, MessageML.MESSAGEML_VERSION);
  }

  @Test
  public void sendValidDateSelector() throws Exception {
    context.parseMessageML("<messageML><form id=\"" + formId + "\"><date-selector name=\"some-name\" placeholder=\"Date placeholder\" required=\"false\"/></form></messageML>", null, MessageML.MESSAGEML_VERSION);
  ...
  public void sendValidDateSelectorWithClosingTag() throws Exception {
    context.parseMessageML("<messageML><form id=\"" + formId + "\"><date-selector name=\"some-name\"></date-selector></form></messageML>", null, MessageML.MESSAGEML_VERSION);
  ...
  public void sendDateSelectorWithChildElement() throws Exception {
    expectedException.expect(InvalidInputException.class);
    expectedException.expectMessage("Element \"date-selector\" may not have child elements or text content");
    context.parseMessageML("<messageML><form id=\"" + formId + "\"><date-selector name=\"some-name\">a</date-selector></form></messageML>", null, MessageML.MESSAGEML_VERSION);
  }
  ...
  public void sendDateSelectorWithInvalidRequiredAttribute() throws Exception {
    ...
    context.parseMessageML("<messageML><form id=\"" + formId + "\"><date-selector name=\"some-name\" placeholder=\"Date placeholder\" required=\"invalid\"/></form></messageML>", null, MessageML.MESSAGEML_VERSION);
  }
  ...
  public void sendDateSelectorWithInvalidAttribute() throws Exception {
    ...
    context.parseMessageML("<messageML><form id=\"" + formId + "\"><date-selector name=\"some-name\" class=\"some-class\"/></form></messageML>", null, MessageML.MESSAGEML_VERSION);
  }

  @Test
  public void sendDateSelectorOutsideForm() throws Exception {
    context.parseMessageML("<messageML><form id=\"" + formId + "\"><div><date-selector name=\"some-name\"/></div></form></messageML>", null, MessageML.MESSAGEML_VERSION);
    ...
    assertEquals("<div data-format=\"PresentationML\" data-version=\"2.0\"><form id=\"" + formId +
        "\"><div><div class=\"date-selector\" data-name=\"some-name\"></div></div></form></div>", context.getPresentationML());
