 ...
 *
 * Beware:
 *  If the element implementing this interface overrides {@link Element#buildAttribute(MessageMLParser, org.w3c.dom.Node)} and/or {@link Element#asPresentationML(XmlPrintStream out,
